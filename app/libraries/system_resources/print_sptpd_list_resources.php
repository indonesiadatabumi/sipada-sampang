...
class print_sptpd_list_resources
{
	...
	public static $_SQL_LIST = "SELECT a.nama,a.alamat,b.npwprd,c.persen_tarif,c.nilai_terkena_pajak,
									...
									to_char(c.masa_pajak1,'dd-mm-yyyy') as masa_pajak1,to_char(c.masa_pajak2,'dd-mm-yyyy') as masa_pajak2, d.volume
									...
									LEFT JOIN spt_detil as d ON (c.spt_id=d.spt_id) ";
}
