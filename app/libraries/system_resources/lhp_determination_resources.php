<?php
	...
	class lhp_determination_resources{

		public static $_TBL_NAME = "penetapan_pajak";
		public static $_PK = "penetapan_id";
		public static $_SQL_LIST = "SELECT a.penetapan_id,b.lhp_id,b.kode_billing,a.kohir,b.nama_paret,a.tahun_pajak,b.npwprd,b.nama_wp,b.no_pemeriksaan,
									...
									LEFT JOIN (SELECT w.lhp_id,w.kode_billing,x.nama_paret,w.pajak,w.no_pemeriksaan,y.nama as nama_wp,
