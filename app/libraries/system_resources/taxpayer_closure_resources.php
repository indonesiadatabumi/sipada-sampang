<?php
	...
	class taxpayer_closure_resources{

		public static $_TBL_NAME = "wp_wr_penutupan";
		public static $_PK = "wp_wr_penutupan_id";
		public static $_SQL_LIST = "SELECT a.wp_wr_penutupan_id,b.npwprd,b.nama as nama_wpwr,
									...
									to_char(a.tgl_tutup,'dd-mm-yyyy') as tgl_tutup
