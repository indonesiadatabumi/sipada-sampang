...
<head>
    ...
    <!--
        #success_message { 
            border: 1px solid #000; width: 550px; text-align: left; padding: 10px 7px; background: #33ff33; color: #000; font-weight: bold; font-size: 1.2em; border-radius: 4px; -moz-border-radius: 4px; -webkit-border-radius: 4px; 
        }
        fieldset { width: 90%; }
...
<form method="post" action="" id="contact_form" onsubmit="return processForm()">
  ...
  <p>
    <?php require_once dirname(__FILE__) . '/securimage.php'; echo Securimage::getCaptchaHtml(array('input_name' => 'ct_captcha')); ?>
  </p>
