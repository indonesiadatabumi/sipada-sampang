<?php
	...
	class pembatalan_transaksi_pajak_model extends CI_Model{

		private $pembatalan_transaksi_id,$transaksi_id,$spt_id,$pajak_id,$wp_wr_id,
				$wp_wr_detil_id,$jenis_spt_id,$loket_pembayaran_id,$no_spt,$no_bukti,
				$tahun_pajak,$masa_pajak1,$masa_pajak2,$total_bayar,$tgl_bayar,
				$tgl_jatuh_tempo,$tgl_pembatalan,$created_by,$created_time;

		const pkey = "pembatalan_transaksi_id";
		const tbl_name = "pembatalan_transaksi_pajak";
		...
		function get_pembatalan_transaksi_id() {
			return $this->pembatalan_transaksi_id;
		}
	    ...
	    function get_tgl_pembatalan() {
	        return $this->tgl_pembatalan;
	    }
	    ...
	    function set_no_spt($data) {
	        $this->no_spt=$data;
	    }

	    function set_no_bukti($data) {
	        $this->no_bukti=$data;
	    }
	    ...
	    function set_tgl_pembatalan($data) {
	        $this->tgl_pembatalan=$data;
	    }
