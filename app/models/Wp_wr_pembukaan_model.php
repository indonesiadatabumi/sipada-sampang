<?php
	...
	class wp_wr_pembukaan_model extends CI_Model{

		private $wp_wr_pembukaan_id,$wp_wr_detil_id,$no_berita_acara,$tgl_berita_acara,$isi_berita_acara,
				$tgl_buka,$created_by,$created_time,$modified_by,$modified_time;

		const pkey = "wp_wr_pembukaan_id";
		const tbl_name = "wp_wr_pembukaan";
		...
		function get_wp_wr_pembukaan_id() {
			return $this->wp_wr_pembukaan_id;
		}
		...
		function set_wp_wr_pembukaan_id($data) {
			$this->wp_wr_pembukaan_id=$data;
		}
