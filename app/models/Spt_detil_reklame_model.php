...
class spt_detil_reklame_model extends CI_Model
{
	...
	private $spt_detil_reklame_id, $spt_id, $spt_detil_id, $jenis_reklame_id, $area,
		...
		$nilai_sewa_reklame, $persen_tarif, $pajak, $tgl_pasang, $tgl_berakhir, $status, $panjang, $lebar, $sisi;
	...
	function set_panjang($data)
	{
		$this->panjang = $data;
	}

	function set_lebar($data)
	{
		$this->lebar = $data;
	}

	function set_sisi($data)
	{
		$this->sisi = $data;
	}
