<form class="form-horizontal" id="form-user" action="<?= base_url() . "/config/update_gol_hotel"; ?>" method="POST">
    <fieldset>
        <input type="hidden" name="ref_kode" value="<?= $detail_gol_hotel->ref_kode ?>" />
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    <label class="control-label col-md-3"><b>Golongan Hotel</b></label>
                    <div class="col-md-9">
                        <div class="input">
                            <input class="form-control" name="golongan" placeholder="Golongan Hotel" value="<?= $detail_gol_hotel->golongan; ?>" />
                        </div>
                    </div>
                </div>
            </div>
