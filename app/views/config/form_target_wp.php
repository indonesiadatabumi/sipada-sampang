<form class="form-horizontal" id="form-user" action="<?= base_url() . "/config/update_target_wp"; ?>" method="POST">
    <fieldset>
        <input type="hidden" name="id_target" value="<?= $detail_target_wp->id_target ?>" />
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input">
                            <input class="form-control" value="<?= $detail_target_wp->nama_paret; ?>" readonly />
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-md-3"><b>Target WP</b></label>
                    <div class="col-md-9">
                        <div class="input">
                            <input class="form-control" name="target_wp" value="<?= $detail_target_wp->target_wp; ?>" />
                        </div>
                    </div>
                </div>
            </div>
