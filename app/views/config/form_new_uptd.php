<form class="form-horizontal" id="form-user" action="<?= base_url() . "/config/add_uptd"; ?>" method="POST">
    <fieldset>
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input">
                            <input class="form-control" name="nama" placeholder="Nama UPTD" />
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input">
                            <input class="form-control" name="uptd_alamat" placeholder="Alamat UPTD" />
                        </div>
                    </div>
                </div>
            </div>
