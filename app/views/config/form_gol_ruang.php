<form class="form-horizontal" id="form-user" action="<?= base_url() . "/config/update_gol_ruang"; ?>" method="POST">
    <fieldset>
        <input type="hidden" name="ref_goru_id" value="<?= $detail_gol_ruang->ref_goru_id ?>" />
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    <label class="control-label col-md-3"><b>Golongan Ruang</b></label>
                    <div class="col-md-9">
                        <div class="input">
                            <input class="form-control" name="gol_ruang" placeholder="Golongan Ruang" value="<?= $detail_gol_ruang->gol_ruang; ?>" />
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-md-3"><b>Pangkat</b></label>
                    <div class="col-md-9">
                        <div class="input">
                            <input class="form-control" name="pangkat" placeholder="Pangkat" value="<?= $detail_gol_ruang->pangkat; ?>" />
                        </div>
                    </div>
                </div>
            </div>
