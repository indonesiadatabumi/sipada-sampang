<form class="form-horizontal" id="form-user" action="<?= base_url() . "/config/update_jenis_kamarhotel"; ?>" method="POST">
    <fieldset>
        <input type="hidden" name="ref_jenmartel_id" value="<?= $detail_jenis_kamarhotel->ref_jenmartel_id ?>" />
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    <label class="control-label col-md-3"><b>Jenis Kamar Hotel</b></label>
                    <div class="col-md-9">
                        <div class="input">
                            <input class="form-control" name="jenis_martel" placeholder="Jenis Kamar Hotel" value="<?= $detail_jenis_kamarhotel->jenis_martel; ?>" />
                        </div>
                    </div>
                </div>
            </div>
