<form class="form-horizontal" id="form-user" action="<?= base_url() . "/config/update_jabatan_pejabatdaerah"; ?>" method="POST">
    <fieldset>
        <input type="hidden" name="ref_japeda_id" value="<?= $detail_jabatan_pejabatdaerah->ref_japeda_id ?>" />
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    <label class="control-label col-md-3"><b>Nama Jabatan</b></label>
                    <div class="col-md-9">
                        <div class="input">
                            <input class="form-control" name="nama_jabatan" placeholder="Nama Jabatan" value="<?= $detail_jabatan_pejabatdaerah->nama_jabatan; ?>" />
                        </div>
                    </div>
                </div>
            </div>
