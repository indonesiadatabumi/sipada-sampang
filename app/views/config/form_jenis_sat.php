<form class="form-horizontal" id="form-user" action="<?= base_url() . "/config/update_jenis_sat"; ?>" method="POST">
    <fieldset>
        <input type="hidden" name="ref_jensat_id" value="<?= $detail_jenis_sat->ref_jensat_id ?>" />
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    <label class="control-label col-md-3"><b>Jenis SAT</b></label>
                    <div class="col-md-9">
                        <div class="input">
                            <input class="form-control" name="jenis_sat" placeholder="Jenis SAT" value="<?= $detail_jenis_sat->jenis_sat; ?>" />
                        </div>
                    </div>
                </div>
            </div>
