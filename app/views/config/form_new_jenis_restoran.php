<form class="form-horizontal" id="form-user" action="<?= base_url() . "/config/add_jenis_restoran"; ?>" method="POST">
    <fieldset>
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input">
                            <input class="form-control" name="jenis_restoran" placeholder="Jenis Restoran" />
                        </div>
                    </div>
                </div>
            </div>
