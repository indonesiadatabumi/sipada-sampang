<form class="form-horizontal" id="form-user" action="<?= base_url() . "/config/add_indeks_ketinggian"; ?>" method="POST">
    <fieldset>
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input">
                            <input class="form-control" name="ketinggian" placeholder="Ketinggian" />
                        </div>
                    </div>
                </div>
                <div class="form-group">
