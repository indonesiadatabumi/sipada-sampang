<form class="form-horizontal" id="form-user" action="<?= base_url() . "/config/update_harga_air"; ?>" method="POST">
    <fieldset>
        <input type="hidden" name="ref_hrgab_id" value="<?= $detail_harga_air->ref_hrgab_id ?>" />
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    <label class="control-label col-md-3"><b>Deskripsi</b></label>
                    <div class="col-md-9">
                        <div class="input">
                            <input class="form-control" name="deskripsi" placeholder="Deskripsi" value="<?= $detail_harga_air->deskripsi; ?>" />
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-md-3"><b>Harga Satuan</b></label>
                    <div class="col-md-9">
                        <div class="input">
                            <input class="form-control" name="harga_satuan" placeholder="Harga Satuan" value="<?= $detail_harga_air->harga_satuan; ?>" />
                        </div>
                    </div>
                </div>
            </div>
