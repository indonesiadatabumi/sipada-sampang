<form class="form-horizontal" id="form-user" action="<?= base_url() . "/config/update_target_pajak"; ?>" method="POST">
    <fieldset>
        <input type="hidden" name="id_target" value="<?= $detail_target_pajak->id_target ?>" />
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input">
                            <input class="form-control" value="<?= $detail_target_pajak->nama_paret; ?>" readonly />
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-md-3"><b>Target Pajak</b></label>
                    <div class="col-md-9">
                        <div class="input">
                            <input class="form-control" name="target_pajak" value="<?= $detail_target_pajak->target_pajak; ?>" />
                        </div>
                    </div>
                </div>
            </div>
