<form class="form-horizontal" id="form-user" action="<?= base_url() . "/config/update_indeks_kawasan"; ?>" method="POST">
    <fieldset>
        <input type="hidden" name="ref_indeks_id" value="<?= $detail_indeks_kawasan->ref_indeks_id ?>" />
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    <label class="control-label col-md-3"><b>Kawasan</b></label>
                    <div class="col-md-9">
                        <div class="input">
                            <input class="form-control" name="kawasan" placeholder="Kawasan" value="<?= $detail_indeks_kawasan->kawasan; ?>" />
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input">
                            <input class="form-control" name="skor" placeholder="Skor" value="<?= $detail_indeks_kawasan->skor; ?>" />
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input">
                            <input class="form-control" name="indeks" placeholder="Indeks" value="<?= $detail_indeks_kawasan->indeks; ?>" />
                        </div>
                    </div>
                </div>
            </div>
