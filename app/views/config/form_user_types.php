<form class="form-horizontal" id="form-user" action="<?= base_url() . "/config/update_type"; ?>" method="POST">
    <fieldset>
        <input type="hidden" name="user_type_id" value="<?= $detail_user_types->user_type_id ?>" />
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    <label class="control-label col-md-3"><b>Role Akses</b></label>
                    <div class="col-md-9">
                        <div class="input">
                            <input class="form-control" name="name" placeholder="Role Akses" value="<?= $detail_user_types->name; ?>" />
                        </div>
                    </div>
                </div>
            </div>
