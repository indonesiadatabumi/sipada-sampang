		...
		<div class='panel panel-default'>
		    <div class='panel-body'>
		    	...
		    	<form id='form-tax_transaction' method='POST' action='".base_url()."payment/submit_form'>
		    		...
		    		<input type='hidden' name='input-tgl_jatuh_tempo' value='".$row['tgl_jatuh_tempo']."'/>
		    		<input type='hidden' name='input-loket_pembayaran_id' value='".$this->session->userdata('payment_locket_id')."'/>
