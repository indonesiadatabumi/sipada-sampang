<form class="form-horizontal" id="form-user" action="<?= base_url() . "/config/update_pejabat_daerah"; ?>" method="POST">
    <fieldset>
        <input type="hidden" name="pejda_id" value="<?= $detail_pejabat_daerah->pejda_id ?>" />
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input">
                            <input class="form-control" name="nama" placeholder="Nama" value="<?= $detail_pejabat_daerah->nama ?>" />
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-md-3"><b>Jabatan</b></label>
                    <div class="col-md-9">
                        <div class="input">
                            <select class="form-control form-control-sm" name="japeda_id" id="japeda_id">
                                <option value="" disabled selected>-Choose Jabatan-</option>
                                <?php
                                foreach ($jabatan->result() as $row) :
                                    // var_dump($row);
                                ?>
                                    <option value="<?= $row->ref_japeda_id; ?>"><?= $row->nama_jabatan_id; ?></option>
                                <?php endforeach ?>
                            </select>
                        </div>
                    </div>
                ...
                <div class="form-group">
                    <label class="control-label col-md-3"><b>Golongan</b></label>
                    <div class="col-md-9">
                        <div class="input">
                            <select class="form-control form-control-sm" name="goru_id" id="goru_id">
                                <option value="" disabled selected>-Choose Golongan-</option>
                                <?php
                                foreach ($golongan->result() as $row) :
                                    // var_dump($row);
                                ?>
                                    <option value="<?= $row->ref_goru_id; ?>"><?= $row->pangkat; ?></option>
                                <?php endforeach ?>
                            </select>
                        </div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input">
                            <input class="form-control" name="nip" placeholder="NIP" value="<?= $detail_pejabat_daerah->nip ?>" />
                        </div>
                    </div>
                </div>
            </div>
