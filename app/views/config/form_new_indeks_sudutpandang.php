<form class="form-horizontal" id="form-user" action="<?= base_url() . "/config/add_indeks_sudutpandang"; ?>" method="POST">
    <fieldset>
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input">
                            <input class="form-control" name="sudut_pandang" placeholder="Sudut Pandang" />
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input">
                            <input class="form-control" name="skor" placeholder="Skor" />
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input">
                            <input class="form-control" name="indeks" placeholder="Indeks" />
                        </div>
                    </div>
                </div>
            </div>
