<form class="form-horizontal" id="form-user" action="<?= base_url() . "/config/update_komponen_airtanah"; ?>" method="POST">
    <fieldset>
        <input type="hidden" name="ref_komponen_id" value="<?= $detail_komponen_airtanah->ref_komponen_id ?>" />
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    <label class="control-label col-md-3"><b>Komponen</b></label>
                    <div class="col-md-9">
                        <div class="input">
                            <input class="form-control" name="komponen" placeholder="Komponen" value="<?= $detail_komponen_airtanah->komponen; ?>" />
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-md-3"><b>Bobot</b></label>
                    <div class="col-md-9">
                        <div class="input">
                            <input class="form-control" name="bobot" placeholder="Bobot" value="<?= $detail_komponen_airtanah->bobot; ?>" />
                        </div>
                    </div>
                </div>
            </div>
