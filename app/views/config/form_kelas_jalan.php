<form class="form-horizontal" id="form-user" action="<?= base_url() . "/config/update_kelas_jalan"; ?>" method="POST">
    <fieldset>
        <input type="hidden" name="ref_kelas_jalan_id" value="<?= $detail_kelas_jalan->ref_kelas_jalan_id ?>" />
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input">
                            <input class="form-control" name="kelas_jalan" placeholder="Kelas Jalan" value="<?= $detail_kelas_jalan->kelas_jalan; ?>" />
                        </div>
                    </div>
                </div>
            </div>
