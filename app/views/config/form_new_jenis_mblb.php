<form class="form-horizontal" id="form-user" action="<?= base_url() . "/config/add_jenis_mblb"; ?>" method="POST">
    <fieldset>
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input">
                            <input class="form-control" name="jenis_mblb" placeholder="Jenis MBLB" />
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input">
                            <input class="form-control" name="tarif_kubik" placeholder="Tarif Kubik" />
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input">
                            <input class="form-control" name="tarif_ton" placeholder="Tarif Ton" />
                        </div>
                    </div>
                </div>
            </div>
