<form class="form-horizontal" id="form-user" action="<?= base_url() . "/config/update_indeks_kelasjalan"; ?>" method="POST">
    <fieldset>
        <input type="hidden" name="ref_indeks_id" value="<?= $detail_indeks_kelasjalan->ref_indeks_id ?>" />
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    <label class="control-label col-md-3"><b>Kelas Jalan</b></label>
                    <div class="col-md-9">
                        <div class="input">
                            <input class="form-control" name="kelas_jalan" placeholder="Kelas Jalan" value="<?= $detail_indeks_kelasjalan->kelas_jalan; ?>" />
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input">
                            <input class="form-control" name="skor" placeholder="Skor" value="<?= $detail_indeks_kelasjalan->skor; ?>" />
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input">
                            <input class="form-control" name="indeks" placeholder="Indeks" value="<?= $detail_indeks_kelasjalan->indeks; ?>" />
                        </div>
                    </div>
                </div>
            </div>
