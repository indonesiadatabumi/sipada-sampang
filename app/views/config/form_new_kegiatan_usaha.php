<form class="form-horizontal" id="form-user" action="<?= base_url() . "/config/add_kegiatan_usaha"; ?>" method="POST">
    <fieldset>
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input">
                            <input class="form-control" name="nama_kegus" placeholder="Nama Kegiatan Usaha" />
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input">
                            <input class="form-control" name="persen_tarif" placeholder="Tarif(%)" />
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input">
                            <input class="form-control" name="tarif_dasar" placeholder="Tarif Dasar" />
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input">
                            <input class="form-control" name="tarif_tambahan" placeholder="Tarif Tambahan" />
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input">
                            <input class="form-control" name="volume_dasar" placeholder="Volume Dasar" />
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input">
                            <input class="form-control" name="kode_rekening" placeholder="Kode Rekening" />
                        </div>
                    </div>
                </div>
            </div>
