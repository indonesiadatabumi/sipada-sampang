...
<html>
	<head>
		<title>'" . $this->config->item('sys_name_acr') . ' ' . $system_params[7] . ' ' . $system_params[6] . " | Laporan Pajak Daerah</title>
				...
				<tr>					
					<td>
						<table class='noborder' style='font-weight:bold'>
							<tr>
								<td align='right'><h3>LAPORAN :</h3></td>
								<td>&nbsp;TARGET DAN REALISASI PENDAPATAN PAJAK DAERAH " . strtoupper($system_params[7] . " " . $system_params[6]) . "</td>
							</tr>
							<tr><td></td><td>&nbsp;TAHUN ANGGARAN " . $tax_year . "</td></tr>
							<tr>
								<td></td>
								<td>
									<table class='noborder'>
										<tr><td width='10%'></td></tr>
										<tr><td>BULAN</td><td>: " . strtoupper($periode_report) . " " . $tax_year . "</td></tr>
									</table>
								</td>
							</tr>
						</table>
...
$mpdf->SetTitle('Laporan Pajak Daerah');
$mpdf->WriteHTML($html);
$mpdf->Output('laporan_pajak_daerah.pdf', 'I');
