...
<section class="portfolio-showcase-block min-height-maincontent">
	<div class="box">
		<div class="row">
			<div class="col-md-6">
				<h5>
					<i class="fa fa-print"></i> Cetak Daftar SPTPD (Self Assessment)
				</h5>
			</div>
			<div class="col-md-6">
				<ul class="breadcrumb">
					...
					<li>Cetak Daftar SPTPD (Self Assessment)</li>
				</ul>
			</div>
		</div>
							...
							<div class="panel-heading">
								<h4 class="panel-title">
									<a class="style1" data-toggle="collapse" data-parent="#accordion" href="#collapse1">
										Berdasarkan Masa Pajak SPTPD</a>
								</h4>
							</div>
									...
									<form class="form-horizontal" id="search_form1" action="<?= base_url() . "/bundle/taxes/" . $bundle_item_type . "/" . $menu . "/report_controller"; ?>" method="POST">
										...
										<fieldset>
											...
											<div class="form-group">
												...
												<div class="col-md-2">
													<div class="input state-disabled">
														<select class="form-control" name="src1-kegus_id" id="src1-kegus_id">
															<option value="" selected></option>
															<?php
											...
											<div class="form-group">
												<label class="control-label col-md-2">Lihat Daftar SPTPD</label>
												<div class="col-md-4">
													<div class="input state-disabled">
														<select class="form-control" name="src1-status" id="src1-status">
															<?php
															// $opts = array("1" => "SPT yang sudah dilaporkan", "2" => "SPT yang belum dilaporkan", "3" => "SPT yang sudah dan belum dilaporkan");
															$opts = array("1" => "SPT yang sudah dilaporkan", "2" => "SPT yang belum dilaporkan");
							...
							<div class="panel-heading">
								<h4 class="panel-title">
									<a class="style1" data-toggle="collapse" data-parent="#accordion" href="#collapse2">
										Berdasarkan Tanggal Pendataan SPTPD</a>
								</h4>
							</div>
									...
									<form class="form-horizontal" id="search_form2" action="<?= base_url() . "/bundle/taxes/" . $bundle_item_type . "/" . $menu . "/report_controller"; ?>" method="POST">
										...
										<fieldset>
											...
											<div class="form-group">
												...
												<div class="col-md-2">
													<div class="input state-disabled">
														<select class="form-control" name="src2-kegus_id" id="src2-kegus_id">
															<option value="" selected></option>
															<?php
															foreach ($kegus as $row) {
																echo "<option value='" . $row['ref_kegus_id'] . "'>" . $row['nama_kegus'] . "</option>";
