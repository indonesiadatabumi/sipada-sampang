...
<section class="portfolio-showcase-block min-height-maincontent">
	<div class="box">
		<div class="row">
			<div class="col-md-6">
				<h5>
					<i class="fa fa-pencil-square-o"></i> Penetapan SKPD
				</h5>
			</div>
			<div class="col-md-6">
				<ul class="breadcrumb">
							...
							<div class="row">
								<div class="col-md-10 col-md-offset-2">
									...
									if ($add_priv == '0') {
										...
										echo "<button class='btn btn-default' type='button' id='btn-add1' data-toggle='modal' data-target='#formModal' onclick=\"load_spt_search_panel(this.id)\">";
									}
									echo "
			...
			<div class="modal-dialog modal-lg" style="width:1200px!important;">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="defModalHead">Form Data Penetapan SKPD</h4>
					</div>
...
<script type="text/javascript">
	...
	function load_spt_search_panel(id) {
		ajax_object.reset_object();
		...
		ajax_object.set_url(base_url + 'bundle/taxes/' + bundle_item_type + '/' + menu + '/spt_search_panel')
			.set_id_input(id)
