			...
			foreach($rows as $row){
				...
				echo "<tr>
					...
					<td align='center'>";
						...
						echo "
						<button type='button' id='btn-balik_nama".$no."' class='btn btn-default btn-xs' onclick=\"if(confirm('Anda yakin untuk balik nama wp berikut?')){balik_nama(this.id)}\" title='Balik Nama'>
						<input type='hidden' id='ajax-req-dt' name='id' value='".$row['wp_wr_id']."'/>
						<input type='hidden' id='ajax-req-dt' name='menu' value='".$menu."'/>
