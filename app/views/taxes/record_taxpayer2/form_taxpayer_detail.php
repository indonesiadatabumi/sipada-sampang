		...
		<div class="row">
			<div class="col-md-6">
				<div class="form-group">
					<label class="control-label col-md-3"><b>Jenis Pajak</b>
						<font color="red">*</font>
					</label>
					<div class="col-md-9">
				...
				<div class="form-group">
					...
					<div class="col-md-9">
						<div class="input state-disabled">
							...
							<?php
							echo "
							<select class='form-control' name='input2-kegus_id' id='input2-kegus_id' " . ($act == 'edit' ? 'required' : 'readonly') . ">";
							if ($act != 'add') {
...
<script type="text/javascript">
	...
	function get_business_types(tax_val, content_id, loader_id, type = '1', selected = '') {
		...
		var $advanced1 = $('#advanced-form2-content1'),
			$advanced2 = $('#advanced-form2-content2'),
			$advanced3 = $('#advanced-form2-content3');
