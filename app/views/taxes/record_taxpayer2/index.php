...
<script type="text/javascript">
	...
	function trigger_sda() {
		setTimeout(function() {
			var zona_val = document.getElementById('input1-jenis_sat_id')?.value;
			if (zona_val && zona_val !== '-') {
				get_sda(zona_val, 'input1-kompkom_id', 'loader-input1_kompkom_id');
			}
		}, 300); // delay biar input-nya sempat kebentuk dulu
	}
