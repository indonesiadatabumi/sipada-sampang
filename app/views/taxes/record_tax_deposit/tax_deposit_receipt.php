		    	...
		    	<div class='row'>
		    		<div class='col-md-8'>
		    			<table class='table table-bordered table-hover'>
		    				...
		    				<tfoot>
		    					<tr><td colspan='3' align='right'><b>Pokok Pajak Rp.</b></td><td align='right'>".number_format($row['pokok_pajak'])."</b></td></tr>
		    					<tr><td colspan='3' align='right'><b>Denda Rp.</b></td><td align='right'>".number_format($row['denda'])."</b></td></tr>
		    					<tr><td colspan='3' align='right'><b>Total Rp.</b></td><td align='right'>".number_format($row['total_bayar'])."</b></td></tr>
		    				</tfoot>
		    			</table>
		    		...
		    		<div class='col-md-4'>
		    			<table class='table'>
		    				<tbody>
			    				...
			    				<tr><td>Jumlah Setoran</td><td>".number_format($row['total_bayar'])."</td></tr>			    				
			    			</tbody>
		    			</table>
		    		</div>
		    	</div>
