...
<section class="portfolio-showcase-block min-height-maincontent">
  	<div class="box">
  		<div class="row">
  			<div class="col-md-6">
			    <h5>
			  	<i class="fa fa-print"></i> Cetak Daftar WP Tutup
			  	</h5>
			</div>
			<div class="col-md-6">
				<ul class="breadcrumb">
		      		...
		      		<form class="form-horizontal" id="search_form" action="<?=base_url()."/bundle/taxes/".$bundle_item_type."/".$menu."/report_controller";?>" method="POST">
		      			...
		      			<fieldset>		      				
			      			...
			      			<div class="form-group">
								...
								<div class="col-md-6">
									<div class="input state-disabled">
										<select class="form-control" name="src-kecamatan_id" id="src-kecamatan_id">
							...
							<div class="form-group">
								<label class="control-label col-md-2">Tgl. Tutup</label>
								<div class="col-md-2">
									<div class="input">
										<input type="text" class="form-control" name="src-tgl_tutup_awal" id="src-tgl_tutup_awal" placeholder="Awal"/>
									</div>
								</div>
								<div class="col-md-2">
									<div class="input">
										<input type="text" class="form-control" name="src-tgl_tutup_akhir" id="src-tgl_tutup_akhir" placeholder="Akhir"/>
									</div>
								</div>
							</div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		$("#src-tgl_tutup_awal,#src-tgl_tutup_akhir,#printAttr-print_date").mask('99-99-9999');		

		// START AND FINISH DATE
		$("#src-tgl_tutup_awal,#src-tgl_tutup_akhir,#printAttr-print_date").datepicker({
			dateFormat : 'dd-mm-yy',
