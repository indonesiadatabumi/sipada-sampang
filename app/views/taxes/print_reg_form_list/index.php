...
<section class="portfolio-showcase-block min-height-maincontent">
  	<div class="box">
  		<div class="row">
  			<div class="col-md-6">
			    <h5>
			  	<i class="fa fa-print"></i> Cetak Daftar Formulir Pendaftaran
			  	</h5>
			</div>
			<div class="col-md-6">
				<ul class="breadcrumb">
				  ...
				  <li>Cetak Daftar Formulir Pendaftaran</li>
				</ul>
			</div>
		</div>
		      		...
		      		<form class="form-horizontal" id="search_form" action="<?=base_url()."/bundle/taxes/".$bundle_item_type."/".$menu."/report_controller";?>" method="POST">
		      			...
		      			<fieldset>
		      				<div class="form-group">
		      					<label class="control-label col-md-2">No. Formulir</label>
								<div class="col-md-2">
									<div class="input">
										<input type="text" class="form-control" name="src-no_formulir_awal" id="src-no_formulir_awal" placeholder="Awal"/>
									</div>
								</div>
								<div class="col-md-2">
									<div class="input">
										<input type="text" class="form-control" name="src-no_formulir_akhir" id="src-no_formulir_akhir" placeholder="Akhir"/>
									</div>
								</div>
		      				</div>
							...
							<div class="form-group">
								...
								<div class="col-md-2">
									<div class="input">
										<input type="text" class="form-control" name="src-tgl_kirim_awal" id="src-tgl_kirim_awal" placeholder="Awal"/>
									</div>
								</div>
								<div class="col-md-2">
									<div class="input">
										<input type="text" class="form-control" name="src-tgl_kirim_akhir" id="src-tgl_kirim_akhir" placeholder="Akhir"/>
									</div>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-2">
									<div class="input state-disabled">
										<select class="form-control" name="src-status" id="src-status">
											<option value="" selected></option>
											<?php
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		$("#src-tgl_kirim_awal,#src-tgl_kirim_akhir,#printAttr-print_date").mask('99-99-9999');		

		// START AND FINISH DATE
		$("#src-tgl_kirim_awal,#src-tgl_kirim_akhir,#printAttr-print_date").datepicker({
			dateFormat : 'dd-mm-yy',
