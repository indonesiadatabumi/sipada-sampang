...
<section class="portfolio-showcase-block min-height-maincontent">
  	<div class="box">
  		<div class="row">
  			<div class="col-md-6">
			    <h5>
			  	<i class="fa fa-pencil-square-o"></i> Penetapan LHP
			  	</h5>
			</div>
			<div class="col-md-6">
				<ul class="breadcrumb">
		      	...
		      	<div class="panel-body">
					...
					<input type="hidden" id="showed" value="0"/>
		      		<form class="form-horizontal" id="search_form" action="<?=base_url()."/bundle/taxes/".$bundle_item_type."/".$menu."/load_list";?>" method="POST">
		      			...
		      			<input type="hidden" name="src-a#tipe_penetapan" id="determination_id" value="2"/>
		      			<fieldset>
							...
							<div class="form-group">
								...
								<div class="col-md-2">
									<div class="input">
										<input type="text" class="form-control" name="src_date_range-tgl_penetapan-start" id="src-tgl_penetapan_awal" placeholder="Awal"/>
									</div>
								</div>
								<div class="col-md-2">
									<div class="input">
										<input type="text" class="form-control" name="src_date_range-tgl_penetapan-end" id="src-tgl_penetapan_akhir" placeholder="Akhir"/>
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-md-10 col-md-offset-2">										
									...
									if($add_priv=='0'){
										...
										echo "<button class='btn btn-default' type='button' id='btn-add1' data-toggle='modal' data-target='#formModal' onclick=\"load_lhp_search_panel(this.id)\">";
									}
									echo "
		    ...
		    <div class="modal-dialog modal-lg" style="width:1200px!important;">
		        <div class="modal-content">
		            <div class="modal-header">
		                ...
		                <h4 class="modal-title" id="defModalHead">Form Data Penetapan LHP</h4>
		            </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		$("#src-tgl_penetapan_awal,#src-tgl_penetapan_akhir").mask('99-99-9999');		

		// START AND FINISH DATE
		$("#src-tgl_penetapan_awal,#src-tgl_penetapan_akhir").datepicker({
			dateFormat : 'dd-mm-yy',
	...
	function show_all_data(){
		ajax_object.reset_object();
		data_ajax = ['menu='+$('#menu').val(),'src-a#pajak_id='+$('#bundle_id').val(),'src-a#tipe_penetapan='+$('#determination_id').val()];
	...
	function load_lhp_search_panel(id){
		ajax_object.reset_object();
		...
		if(showed=='2'){			
			...
			data_ajax.push("src_date_range-tgl_penetapan-start="+$('#src-tgl_penetapan_awal').val());
			data_ajax.push("src_date_range-tgl_penetapan-end="+$('#src-tgl_penetapan_akhir').val());
		}		

        ajax_object.set_url(base_url+'bundle/taxes/'+bundle_item_type+'/'+menu+'/lhp_search_panel')
        		   .set_id_input(id)
	...
	function load_form_content(id){
		...
		if(showed=='2'){			
			...
			data_ajax.push("src_date_range-tgl_penetapan-start="+$('#src_params-tgl_penetapan_awal').val());
			data_ajax.push("src_date_range-tgl_penetapan-end="+$('#src_params-tgl_penetapan_akhir').val());
		}		
	...
	function delete_record(id){
		...
		data_ajax = ['src-tahun_pajak='+$('#src_params-tahun_pajak').val(),					 
					 ...
					 "src_date_range-tgl_penetapan-start="+$('#src_params-tgl_penetapan_awal').val(),
					 "src_date_range-tgl_penetapan-end="+$('#src_params-tgl_penetapan_akhir').val()
					 ];
