...
<section class="portfolio-showcase-block min-height-maincontent">
	<div class="box">
		<div class="row">
			<div class="col-md-6">
				<h5>
					<i class="fa fa-pencil-square-o"></i> Rekam Laporan Hasil Pemeriksaan (LHP))
				</h5>
			</div>
			<div class="col-md-6">
				<ul class="breadcrumb">
					...
					<li>Rekam Laporan Hasil Pemeriksaan (LHP)</li>
				</ul>
			</div>
		</div>
					...
					<form class="form-horizontal" id="search_form" action="<?= base_url() . "/bundle/taxes/" . $bundle_item_type . "/" . $menu . "/load_list"; ?>" method="POST">
						...
						<fieldset>
							...
							<div class="form-group">
								...
								<div class="col-md-6">
									<div class="input state-disabled">
										<select class="form-control" name="src-jenis_spt_id" id="src-jenis_spt_id">
											<option value="" selected></option>
											<?php
			...
			<div class="modal-dialog modal-lg" style="width:1200px!important;">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="defModalHead">Form Laporan Hasil Pemeriksaan (LHP)</h4>
					</div>
