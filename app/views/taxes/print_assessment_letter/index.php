									...
									<div class="input">
										<div class="input-group">
											...
											<div class="input-group-btn">
												<button class="btn btn-default btn-primary" id="btn-kohir_awal" type="button" data-toggle="modal" data-target="#formModal" onclick="load_determination_list(1,$('#src-jenis_spt_id').val(),$('#src1-tahun_pajak').val())" disabled>...</button>
											</div>
										</div>
									</div>
								</div>
								<div class="col-md-2">
									<div class="input">
										<div class="input-group">
											...
											<div class="input-group-btn">
												<button class="btn btn-default btn-primary" id="btn-kohir_akhir" type="button" data-toggle="modal" data-target="#formModal" onclick="load_determination_list(2,$('#src-jenis_spt_id').val(),$('#src1-tahun_pajak').val())" disabled>...</button>
											</div>
										</div>
									</div>
								</div>
...
<script type="text/javascript">
	...
	function load_determination_list(input_id, spt_type, tahun_pajak) {
		ajax_object.reset_object();

		data_ajax = ["input_id=" + input_id, "jenis_spt_id=" + spt_type, "tahun_pajak=" + tahun_pajak];
