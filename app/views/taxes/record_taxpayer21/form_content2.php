...
<script type="text/javascript">
	...
	function load_form2_content(id){
        ...
        ajax_object.set_url(base_url+'bundle/taxes/hotel/record_taxpayer2/form_taxpayer_detail')
        		   .set_id_input(id)
	...
	function delete_record_taxpayer_detail(id){
        ...
        ajax_object.set_url(base_url+'bundle/taxes/hotel/record_taxpayer2/delete_record_taxpayer_detail')
