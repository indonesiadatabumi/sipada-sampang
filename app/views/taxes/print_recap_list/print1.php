			...
			<tbody>
				...
				foreach ($rows1 as $row1) {
					...
					echo "
							<tr>
								...
								<td align='right'><b>" . number_format($total_tax, 0, ',', '.') . "</b></td><td colspan='3'></td>
				...
				echo "
							<tr>
								...
								<td align='right'><b>" . number_format($grand_tax, 0, ',', '.') . "</b></td><td colspan='3'></td>
