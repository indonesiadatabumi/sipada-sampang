...
<section class="portfolio-showcase-block min-height-maincontent">
	<div class="box">
		<div class="row">
			<div class="col-md-6">
				<h5>
					<i class="fa fa-pencil-square-o"></i> Rekam STPD
				</h5>
			</div>
			<div class="col-md-6">
				<ul class="breadcrumb">
			...
			<div class="modal-dialog modal-lg" style="width:1200px!important;">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="defModalHead">Form Rekam STPD</h4>
					</div>
...
<script type="text/javascript">
	...
	function show_all_data() {
		ajax_object.reset_object();
		data_ajax = ['menu=' + $('#menu').val(), 'src-a#stpd_jenis_pajak=' + $('#bundle_id').val()];
