<div class="row">
    <div class="col-md-12">
        <form class="form-horizontal" id="search_form2" action="<?=base_url()."/bundle/taxes/".$bundle_item_type."/".$menu."/load_taxpayer_list";?>" method="POST">
            <input type="hidden" name="menu" id="search_form2-menu" value="<?=$menu;?>"/>
            <input type="hidden" name="act" id="search_form2-act" value="<?=$act;?>"/>
            <input type="hidden" name="showed" name="search_form2-showed" value="<?=$showed;?>"/>
            <?php
            ...
            <div class="form-group">
                <div class="col-md-<?=($bundle_id=='3'?'10':'12');?>">
                ...
                <?php
                    if($bundle_id=='3'){
                        ...
                        <button type='button' class='btn btn-default' id='btn-skipped_reg_form2_content' onclick=\"load_skipped_reg_form2_content()\">Tanpa Pendaftaran</button>
                        </div>";
                    }
                ?>
            </div>
        ...
        <div id="list-data2">
            <div class="alert alert-warning">
                ...
                <?=($bundle_id=='3'?'atau klik Tombol <b><u>Tanpa Pendaftaran</u></b> untuk melakukan pendataan Objek Pajak tanpa melalui Pendaftaran':'');?>!
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    function load_skipped_reg_form2_content(){
        ajax_object.reset_object();
        data_ajax = ["skip_register=1","act="+$('#search_form2-act').val(),"menu="+$('#search_form2-menu').val(),"showed="+$('#search_form2-showed').val()];
        ajax_object.set_url(base_url+'bundle/taxes/'+bundle_item_type+'/'+menu+'/form')
