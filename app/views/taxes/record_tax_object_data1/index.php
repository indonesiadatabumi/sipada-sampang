...
<section class="portfolio-showcase-block min-height-maincontent">
	<div class="box">
		<div class="row">
			<div class="col-md-6">
				<h5>
					<i class="fa fa-pencil-square-o"></i> Rekam Data Objek Pajak
				</h5>
			</div>
			<div class="col-md-6">
				<ul class="breadcrumb">
			...
			<div class="modal-dialog modal-lg" style="width:1200px!important;">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="defModalHead">Form Data Objek Pajak</h4>
					</div>
...
<script type="text/javascript">
	...
	function show_all_data() {
		ajax_object.reset_object();
		data_ajax = ['menu=' + $('#menu').val(), 'src-pajak_id=' + $('#bundle_id').val()];
	...
	function load_taxpayer_search_panel(id) {
		...
		if (showed == '2') {
			...
			data_ajax.push("src-kecamatan_id=" + $('#src-kecamatan_id').val());
			data_ajax.push("src-kelurahan_id=" + $('#src-kelurahan_id').val());
			data_ajax.push("src_date_range-tgl_proses-start=" + $('#src-tgl_proses_awal').val());
			data_ajax.push("src_date_range-tgl_proses-end=" + $('#src-tgl_proses_akhir').val());
		}

		ajax_object.set_url(base_url + 'bundle/taxes/' + bundle_item_type + '/' + menu + '/taxpayer_search_panel')
			.set_id_input(id)
	...
	function load_form_content(id) {
		...
		if (showed == '2') {
			...
			data_ajax.push("src_date_range-tgl_proses-start=" + $('#src_params-tgl_proses_awal').val());
			data_ajax.push("src_date_range-tgl_proses-end=" + $('#src_params-tgl_proses_akhir').val());
		}
	...
	function delete_record(id) {
		...
		data_ajax = ['src-tahun_pajak=' + $('#src_params-tahun_pajak').val(),
			'src-kecamatan_id=' + $('#src_params-kecamatan_id').val(),
			'src-kelurahan_id=' + $('#src_params-kelurahan_id').val(),
			"src_date_range-tgl_proses-start=" + $('#src_params-tgl_proses_awal').val(),
			"src_date_range-tgl_proses-end=" + $('#src_params-tgl_proses_akhir').val()
		];
