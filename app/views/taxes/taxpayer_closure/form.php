    ...
    <fieldset>
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="form-group">
                    <label class="control-label col-md-3">Tgl. Tutup <font color="red">*</font></label>
                    <div class="col-md-3">
                        <div class="input">
                            <input class="form-control datepicker" name="input-tgl_tutup-date" id="input-tgl_tutup" value="<?=indo_date_format($curr_data['tgl_tutup'],'shortDate');?>" required/>
                        </div>                      
                    </div>
                </div>
            </div>            
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        $("#input-tgl_berita_acara,#input-tgl_tutup").mask('99-99-9999');     

        // START AND FINISH DATE
        $('#input-tgl_berita_acara,#input-tgl_tutup').datepicker({
            dateFormat : 'dd-mm-yy',
