...
<section class="portfolio-showcase-block min-height-maincontent">
  	<div class="box">
  		<div class="row">
  			<div class="col-md-6">
			    <h5>
			  	<i class="fa fa-sign-out"></i> Penutupan Wajib Pajak
			  	</h5>
			</div>
			<div class="col-md-6">
				<ul class="breadcrumb">
			...
			<div class="panel panel-default">
		      	<div class="panel-body">
		      		<form class="form-horizontal" id="search_form" action="<?=base_url()."/bundle/taxes/".$bundle_item_type."/".$menu."/load_list";?>" method="POST">
		      			...
		      			<input type="hidden" name="src-b#pajak_id" id="bundle_id" value="<?=$bundle_id;?>"/>
		      			<fieldset>
		    ...
		    <div class="modal-dialog modal-lg">
		        <div class="modal-content">
		            <div class="modal-header">
		                ...
		                <h4 class="modal-title" id="defModalHead">Formulir Penutupan Wajib Pajak</h4>
		            </div>
...
<script type="text/javascript">
	...
	function show_all_data(){
		ajax_object.reset_object();
		data_ajax = ['menu='+$('#menu').val(),'src-b#pajak_id='+$('#bundle_id').val()];
