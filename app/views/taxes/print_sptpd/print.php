					...
					if ($row['pajak_id'] == '1') {
						...
						echo "<tr><td>a.</td><td colspan='4' class='nobor-left'>Penggunaan Tenaga Listrik Periode " . $tax_month . " " . $row['tahun_pajak'] . "</td></tr>
								...
								<table class='report' cellspacing='0'>									
									<tbody>
										<tr><td align='center'>Kapasitas Daya (kVA)</td><td align='center'>Koefisien Daya</td>
										<td align='center'>Pemakaian (jam)</td>
										...
										<td align='center'>5 = (1x2x3x4)</td></tr>
										<tr>
										<td align='right'>" . number_format($row['kapasitas_daya'], 0, '.', ',') . "</td>
										<td align='right'>" . number_format($row['koefisien_daya'], 0, '.', ',') . "</td>
										<td align='right'>" . $row['waktu_pemakaian'] . "</td>
