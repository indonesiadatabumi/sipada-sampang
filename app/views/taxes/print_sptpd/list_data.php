...
<table id="data-table-jq" class="table table-bordered table-striped table-hover">
	...
	<tbody>
		...
		foreach ($rows as $row) {
			...
			if ($print_priv == '1') {
				echo "<a href='" . base_url() . "bundle/" . $bundle_type . "/" . $bundle_item_type . "/" . $menu . "/_print?id=" . $row['spt_id'] . "&tgl_cetak=" . $tgl_cetak . "' id='btn-print" . $no . "' 
			...
			if ($print_priv == '1') {
				echo "<a href='" . base_url() . "bundle/" . $bundle_type . "/" . $bundle_item_type . "/" . $menu . "/_pdf?id=" . $row['spt_id'] . "' id='btn-print" . $no . "' 
