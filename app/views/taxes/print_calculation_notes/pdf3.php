...
foreach ($rows as $row) {
	...
	$html .= "
				...
				<tr><td>No. SPT yang dikirim</td><td>: " . sprintf('%0' . $system_params[16] . 's', $row['kohir']) . "</td></tr></table>
				</td>
				</tr>
				<tr>
	...
	$html .= "<table class='report' cellpadding=0 cellspacing=0><thead>
				  ...
				  <td align='center'>7=(5x6)</td>
				  <td align='center'>8</td>
				  <td align='center'>9</td>
				  <td align='center'>10</td>
				  <td align='center' class='bor-right'>12=(7+8+9+10)</td></tr>
				  </thead>";

	$tax = $row['pajak'] - $row['denda'];
	$discount = $row['diskon'];
	$fine = $row['total_sanksi'];
	$interest = $row['bunga'];
	...
	$html .= "<tbody>
				  ...
				  <td align='center'>" . number_format($row['persen_tarif']) . "%</td>
				  ...
				  <td align='right'>" . number_format($interest) . "</td>
	...
	$html .= "<tfoot>
				<tr><td colspan='6' align='right'><b>JUMLAH</b></td><td align='right'><b>" . number_format($grand_tax) . "</b></td><td align='right'><b>" . number_format($grand_discount) . "</b></td>
