		...
		<div style="border:1px solid #000">
			...
			<table class="report" cellpadding="0" cellspacing="0">
				<tbody>
					...
					<tr>
						<td>2.</td>
						<td colspan="4" class="nobor-left">Beri nomor pada kotak <span style="border:1px solid #000">&nbsp;&nbsp;&nbsp;&nbsp;</span> yang tersedia untuk jawaban yang diberikan.</td>
					</tr>
					<tr>
						<td>3.</td>
						<td colspan="4" class="nobor-left">Setelah diisi dan ditandatangani harap diserahkan kembali kepada Badan Pengelolaan Keuangan Daerah <?= $system_params[7] . " " . $system_params[6]; ?> paling lambat tanggal 10 bulan berikutnya.</td>
					</tr>
					<tr>
						<td>4.</td>
					...
					<tr>
						...
						<td colspan="3" class="nobor-left nobor-top">: <?= $row['npwpd']; ?></td>
					</tr>
					</tr>
					<tr>
					...
					<tr>
						...
						<td colspan="2" align="center">Ada/Tidak ada</td>
					</tr>
					<?php
					if ($row['pajak_id'] == '1' or $row['pajak_id'] == '2' or $row['pajak_id'] == '4') {
						echo "							
