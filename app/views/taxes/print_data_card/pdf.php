<?php
	...
	$html = "<!DOCTYPE html><html><head>
			<title>".$this->config->item('sys_name_acr').' '.$system_params[7].' '.$system_params[6]." | Daftar Kartu Data ".strtoupper($tax_name)."</title>
	...
	if($show_signature){
		...
		$html .= "<div align='right'>".$system_params[6].", ".indo_date_format($print_date,'longDate')."</div>";
	}
