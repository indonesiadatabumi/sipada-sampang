...
<section class="portfolio-showcase-block min-height-maincontent">
	<div class="box">
		<div class="row">
			<div class="col-md-6">
				<h5>
					<i class="fa fa-print"></i> Cetak Daftar Perkembangan WP
				</h5>
			</div>
			<div class="col-md-6">
				<ul class="breadcrumb">
					...
					<li>Cetak Daftar Perkembangan WP</li>
				</ul>
			</div>
		</div>
				...
				<div class="panel-body">
					<form class="form-horizontal" id="search_form" action="<?= base_url() . "/bundle/taxes/" . $bundle_item_type . "/" . $menu . "/report_controller"; ?>" method="POST">
						...
						<fieldset>
							<!-- <div class="form-group">
								...
								<div class="col-md-6">
									<div class="input state-disabled">
										<select class="form-control" name="src-pajak_id" id="src-pajak_id">
											<option value="" selected></option>
											<?php
											foreach ($tax_rows as $row) {
												$selected = ($row['bundel_id'] == $bundle_id ? 'selected' : '');
												echo "<option value='" . $row['bundel_id'] . "' " . $selected . ">" . $row['nama_paret'] . "</option>";
											}
											?>
										</select>
									</div>
							...
							<div class="form-group">
								<label class="control-label col-md-2" for="src-kegus_id">Kegiatan Usaha</label>
								<div class="col-md-6">
									<div class="input state-disabled">
